package com.example.petshopproject.Api;

import com.example.petshopproject.Constant.AppInfo;
import com.example.petshopproject.Helper.Helpers;
...
public class CreateOrder {
    private class CreateOrderData {
     ...
     public JSONObject createOrder(String amount) throws Exception {
        ...
        JSONObject data = com.example.petshopproject.Api.HttpProvider.sendPost(AppInfo.URL_CREATE_ORDER, formBody);
        return data;
    }
}
